 ...
 *
 * { rel: 'apple-touch-icon', sizes: '57x57', href: 'assets/favicon/apple-touch-icon-57x57.png', '=href': false },
...
module.exports = {
  link: [
    ...
    { rel: 'mask-icon', type: 'image/x-icon', sizes: '16x16', href: 'assets/favicon/safari-pinned-tab.svg' },
    { rel: 'shortcut icon', type: 'image/x-icon', sizes: '16x16', href: 'assets/favicon/favicon.ico' },
    { rel: 'icon', type: 'image/x-icon', sizes: '16x16', href: 'assets/favicon/favicon.ico' },
